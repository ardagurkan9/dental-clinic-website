        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-2xl bg-[#0c6ea3] px-8 py-12 text-center shadow-lg">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">
              Dişeti Hastalıkları Tedavileri
            </h1>
            <p className="text-sm text-[#BAE6FD]">
              <Link href="/" className="hover:text-white transition-colors">Ana Sayfa</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <Link href="/tedaviler/diseti-hastaliklari" className="hover:text-white transition-colors">Tedavilerimiz</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <span className="text-white font-medium">Dişeti Hastalıkları</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111827] leading-tight mb-6">
              Dişetleriniz İçin<br className="hidden sm:block" /> Uzman Tedavi
            </h2>
            <p className="text-[#4B5563] leading-relaxed mb-4">
              Dişeti hastalıkları (periodontitis ve gingivitis), ağız sağlığının ihmal edilen ama
              en önemli sorunları arasındadır. Erken teşhis ve uygun tedavi ile dişlerinizi uzun
              yıllar sağlıklı tutmak mümkündür.
            </p>
            <p className="text-[#4B5563] leading-relaxed mb-8">
              Periodontoloji uzmanlarımız, en güncel tanı araçları ve minimal invaziv tedavi
              yöntemleriyle dişetlerinizi sağlığa kavuşturuyor.
            </p>
