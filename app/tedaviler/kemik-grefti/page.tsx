        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-2xl bg-[#0c6ea3] px-8 py-12 text-center shadow-lg">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">
              Kemik Grefti & Rejeneratif Uygulamalar
            </h1>
            <p className="text-sm text-[#BAE6FD]">
              <Link href="/" className="hover:text-white transition-colors">Ana Sayfa</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <Link href="/tedaviler/kemik-grefti" className="hover:text-white transition-colors">Tedavilerimiz</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <span className="text-white font-medium">Kemik Grefti</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-xs font-semibold tracking-widest uppercase mb-3 text-[#0EA5E9]">
              Rejeneratif Diş Hekimliği
            </p>
            <h2 className="text-3xl md:text-4xl font-bold text-[#111827] leading-tight mb-6">
              Kaybedilen Kemiği<br className="hidden sm:block" /> Yeniden İnşa Edin
            </h2>
            <p className="text-[#4B5563] leading-relaxed mb-4">
              Periodontitis veya diş çekiminden kaynaklanan kemik kayıpları, implant tedavisinin
              önünde engel oluşturabilir. Kemik grefti uygulamaları ile bu eksiklik giderilerek
              sağlam bir implant zemini hazırlanır.
            </p>
            <p className="text-[#4B5563] leading-relaxed mb-8">
              Rejeneratif tekniklerimiz; doğal iyileşme sürecini destekleyerek çevrenin kendi
              biyolojik kapasitesini kullanır ve kalıcı sonuçlar sağlar.
            </p>
