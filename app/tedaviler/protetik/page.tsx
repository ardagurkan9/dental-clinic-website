        ...
        <div className="max-w-7xl mx-auto">
          <div className="rounded-2xl bg-[#0c6ea3] px-8 py-12 text-center shadow-lg">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">
              Estetik Protetik & Restoratif Uygulamalar
            </h1>
            <p className="text-sm text-[#BAE6FD]">
              <Link href="/" className="hover:text-white transition-colors">Ana Sayfa</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <Link href="/tedaviler/protetik" className="hover:text-white transition-colors">Tedavilerimiz</Link>
              <span className="mx-2 text-[#7DD3FC]">/</span>
              <span className="text-white font-medium">Estetik Protetik</span>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111827] leading-tight mb-6">
              Estetik ve<br className="hidden sm:block" /> Fonksiyonel Restorasyon
            </h2>
            <p className="text-[#4B5563] leading-relaxed mb-4">
              Kırık, renklenmiş veya şekil bozukluğu olan dişler, modern restoratif tekniklerle
              hem estetik hem de fonksiyonel açıdan iyileştirilebilir. Zirkonyum ve porselen
              altyapılar doğal dişle uyumlu bir görünüm sunar.
            </p>
            <p className="text-[#4B5563] leading-relaxed mb-8">
              Protetik tedavilerimiz bireysel renk, şekil ve boyut planlaması ile tasarlanır;
              böylece her hasta kendine özel bir sonuç elde eder.
            </p>
